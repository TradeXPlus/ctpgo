...
func (p *FtdcMdSpi) OnFrontConnected() {
	...
	MdStr := "=================================================================================================\n" +
		"= 行情模块初始化成功，API 版本：" + ctpgo.CThostFtdcMdApiGetApiVersion() + "\n" +
		"================================================================================================="
	fmt.Println(MdStr)
...
// 登录请求响应
func (p *FtdcMdSpi) OnRspUserLogin(pRspUserLogin ctpgo.CThostFtdcRspUserLoginField, pRspInfo ctpgo.CThostFtdcRspInfoField, nRequestID int, bIsLast bool) {
...
// 退订行情应答
func (p *FtdcMdSpi) OnRspUnSubMarketData(pSpecificInstrument ctpgo.CThostFtdcSpecificInstrumentField, pRspInfo ctpgo.CThostFtdcRspInfoField, nRequestID int, bIsLast bool) {
	if !p.IsErrorRspInfo(pRspInfo) {
...
// 深度行情通知
func (p *FtdcMdSpi) OnRtnDepthMarketData(pDepthMarketData ctpgo.CThostFtdcDepthMarketDataField) {
...
// 行情系统错误通知
func (p *FtdcMdSpi) IsErrorRspInfo(pRspInfo ctpgo.CThostFtdcRspInfoField) bool {
