...
func (p *FtdcTraderSpi) OnFrontConnected() {
	...
	TraderStr := "=================================================================================================\n" +
		"= 交易模块初始化成功，API 版本：" + ctpgo.CThostFtdcTraderApiGetApiVersion() + "\n" +
		"================================================================================================="
...
func (p *FtdcTraderSpi) ReqAuthenticate() {
	...
	req := ctpgo.NewCThostFtdcReqAuthenticateField()
...
// 客户端认证响应
func (p *FtdcTraderSpi) OnRspAuthenticate(pRspAuthenticateField ctpgo.CThostFtdcRspAuthenticateField, pRspInfo ctpgo.CThostFtdcRspInfoField, nRequestID int, bIsLast bool) {
...
func (p *FtdcTraderSpi) ReqUserLogin() {
	...
	req := ctpgo.NewCThostFtdcReqUserLoginField()
	req.SetBrokerID(Ctp.BrokerID)
	req.SetUserID(Ctp.InvestorID)
...
func (p *FtdcTraderSpi) OnRspUserLogin(pRspUserLogin ctpgo.CThostFtdcRspUserLoginField, pRspInfo ctpgo.CThostFtdcRspInfoField, nRequestID int, bIsLast bool) {
...
func (p *FtdcTraderSpi) ReqSettlementInfoConfirm() int {
	...
	req := ctpgo.NewCThostFtdcSettlementInfoConfirmField()
	req.SetBrokerID(Ctp.BrokerID)
...
// 发送投资者结算单确认响应
func (p *FtdcTraderSpi) OnRspSettlementInfoConfirm(pSettlementInfoConfirm ctpgo.CThostFtdcSettlementInfoConfirmField, pRspInfo ctpgo.CThostFtdcRspInfoField, nRequestID int, bIsLast bool) {
...
func (p *FtdcTraderSpi) ReqQryInstrument() int {
	...
	req := ctpgo.NewCThostFtdcQryInstrumentField()
	req.SetInstrumentID("")
...
// 请求查询合约响应
func (p *FtdcTraderSpi) OnRspQryInstrument(pInstrument ctpgo.CThostFtdcInstrumentField, pRspInfo ctpgo.CThostFtdcRspInfoField, nRequestID int, bIsLast bool) {
...
func (p *FtdcTraderSpi) ReqQryTradingAccount() int {
	...
	req := ctpgo.NewCThostFtdcQryTradingAccountField()
	req.SetBrokerID(Ctp.BrokerID)
	req.SetInvestorID(Ctp.InvestorID)
...
// 请求查询资金账户响应
func (p *FtdcTraderSpi) OnRspQryTradingAccount(pTradingAccount ctpgo.CThostFtdcTradingAccountField, pRspInfo ctpgo.CThostFtdcRspInfoField, nRequestID int, bIsLast bool) {
...
func (p *FtdcTraderSpi) ReqQryOrder() int {
	...
	req := ctpgo.NewCThostFtdcQryOrderField()
	req.SetBrokerID(Ctp.BrokerID)
	req.SetInvestorID(Ctp.InvestorID)
...
// 请求查询投资者报单响应
func (p *FtdcTraderSpi) OnRspQryOrder(pOrder ctpgo.CThostFtdcOrderField, pRspInfo ctpgo.CThostFtdcRspInfoField, nRequestID int, bIsLast bool) {
	...
	if !p.IsErrorRspInfo(pRspInfo) {
		...
		if bIsLast {
			...
			for _, v := range mOrderList {
				...
				// 输出 未成交、部分成交 的报单
				if val.OrderStatus == string(ctpgo.THOST_FTDC_OST_NoTradeQueueing) || val.OrderStatus == string(ctpgo.THOST_FTDC_OST_PartTradedQueueing) {
...
func (p *FtdcTraderSpi) ReqQryInvestorPosition() int {
	...
	req := ctpgo.NewCThostFtdcQryInvestorPositionField()
	req.SetBrokerID(Ctp.BrokerID)
	req.SetInvestorID(Ctp.InvestorID)
...
// 请求查询投资者持仓（汇总）响应
func (p *FtdcTraderSpi) OnRspQryInvestorPosition(pInvestorPosition ctpgo.CThostFtdcInvestorPositionField, pRspInfo ctpgo.CThostFtdcRspInfoField, nRequestID int, bIsLast bool) {
...
// 报单通知（委托单）
func (p *FtdcTraderSpi) OnRtnOrder(pOrder ctpgo.CThostFtdcOrderField) {
	...
	if OrderSysID == "" {
		...
		if OrderStatus == ctpgo.THOST_FTDC_OST_Canceled {
	...
	if OrderStatus == ctpgo.THOST_FTDC_OST_NoTradeQueueing || OrderStatus == ctpgo.THOST_FTDC_OST_Canceled {
...
// 成交通知（委托单在交易所成交了）
func (p *FtdcTraderSpi) OnRtnTrade(pTrade ctpgo.CThostFtdcTradeField) {
...
func (p *FtdcTraderSpi) OnRspOrderInsert(pInputOrder ctpgo.CThostFtdcInputOrderField, pRspInfo ctpgo.CThostFtdcRspInfoField, nRequestID int, bIsLast bool) {
...
// 错误应答
func (p *FtdcTraderSpi) OnRspError(pRspInfo ctpgo.CThostFtdcRspInfoField, nRequestID int, bIsLast bool) {
	p.IsErrorRspInfo(pRspInfo)
}

// 报单操作错误回报
func (p *FtdcTraderSpi) OnErrRtnOrderAction(pOrderAction ctpgo.CThostFtdcOrderActionField, pRspInfo ctpgo.CThostFtdcRspInfoField) {
	p.IsErrorRspInfo(pRspInfo)
}

// 报单操作请求响应（撤单失败会触发）
func (p *FtdcTraderSpi) OnRspOrderAction(pInputOrderAction ctpgo.CThostFtdcInputOrderActionField, pRspInfo ctpgo.CThostFtdcRspInfoField, nRequestID int, bIsLast bool) {
	p.IsErrorRspInfo(pRspInfo)
}

// 交易系统错误通知
func (p *FtdcTraderSpi) IsErrorRspInfo(pRspInfo ctpgo.CThostFtdcRspInfoField) bool {
...
func (p *FtdcTraderSpi) OrderOpen(Input InputOrderStruct) int {
	...
	req := ctpgo.NewCThostFtdcInputOrderField()
	...
	// 组合开平标志: 开仓
	req.SetCombOffsetFlag(string(ctpgo.THOST_FTDC_OF_Open))
	// 组合投机套保标志: 投机
	req.SetCombHedgeFlag(string(ctpgo.THOST_FTDC_HF_Speculation))
	// 报单价格条件: 限价
	req.SetOrderPriceType(ctpgo.THOST_FTDC_OPT_LimitPrice)
	// 价格
	req.SetLimitPrice(Input.Price)
	// 数量
	req.SetVolumeTotalOriginal(Input.Volume)
	// 有效期类型: 当日有效
	req.SetTimeCondition(ctpgo.THOST_FTDC_TC_GFD)
	// 成交量类型: 任何数量
	req.SetVolumeCondition(ctpgo.THOST_FTDC_VC_AV)
	// 最小成交量
	req.SetMinVolume(1)
	// 触发条件: 立即
	req.SetContingentCondition(ctpgo.THOST_FTDC_CC_Immediately)
	// 强平原因: 非强平
	req.SetForceCloseReason(ctpgo.THOST_FTDC_FCC_NotForceClose)
	// 自动挂起标志: 否
...
func (p *FtdcTraderSpi) OrderClose(Input InputOrderStruct) int {
	...
	if Input.CombOffsetFlag == 0 {
		...
		if mInstrumentInfo.ExchangeID == "SHFE" {
			// 上期所（默认平今仓）
			Input.CombOffsetFlag = ctpgo.THOST_FTDC_OF_CloseToday
		} else {
			// 非上期所，不用区分今昨仓，直接使用平仓即可
			Input.CombOffsetFlag = ctpgo.THOST_FTDC_OF_Close
		}
	}
...
func (p *FtdcTraderSpi) OrderCancel(InstrumentID string, OrderSysID string) int {
	...
	req := ctpgo.NewCThostFtdcInputOrderActionField()
	...
	// 操作标志
	req.SetActionFlag(ctpgo.THOST_FTDC_AF_Delete)
...
// 获得报单结构体数据
func GetOrderListStruct(pOrder ctpgo.CThostFtdcOrderField) OrderListStruct {
...
// 获得持仓结构体数据
func GetInvestorPositionStruct(pInvestorPosition ctpgo.CThostFtdcInvestorPositionField) InvestorPositionStruct {
	...
	// 冻结的持仓量（多空并成一个字段）
	if mInvestorPosition.PosiDirection == string(ctpgo.THOST_FTDC_PD_Long) {
		// 多头冻结的持仓量
